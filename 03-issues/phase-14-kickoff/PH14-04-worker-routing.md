...
specRef: spec/19-main-worker-service/04-worker-routing.md
status: Todo
...
# PH14-04 — Implement Worker Routing

## Spec Reference
- Source of truth: [`spec/19-main-worker-service/04-worker-routing.md`](../../spec/19-main-worker-service/04-worker-routing.md)
...
## Scope Summary
Materialize chapter 04 (Worker Routing) per the spec. Implementation lives outside
`spec/19/` once the target language and repo are decided.

## Acceptance Criteria
- [ ] Implementation passes spec/19 chapter 04 acceptance items.
