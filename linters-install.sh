...
BUNDLE_NAME="linters"
BUNDLE_MAPPING="linters|linters linters-cicd|linters-cicd version.json|version.json .lovable/what-to-read.md|.lovable/what-to-read.md .lovable/memory|.lovable/memory"
