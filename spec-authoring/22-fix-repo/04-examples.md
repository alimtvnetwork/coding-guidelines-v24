...
`https://github.com/alimtvnetwork/coding-guidelines-v24.git`.
...
only the `coding-guidelines-v24` segment changes because that
...
See coding-guidelines-v24/spec.md for details.
```
