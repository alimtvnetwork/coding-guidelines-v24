  ...
  lint:
    ...
    steps:
      ...
      - name: Run coding-guidelines linters
        uses: alimtvnetwork/coding-guidelines-v24/linters-cicd@v3.79.0
        with:
          path: .
...
- name: Install linter pack
  run: curl -fsSL https://github.com/alimtvnetwork/coding-guidelines-v24/releases/download/v3.79.0/install.sh | bash
