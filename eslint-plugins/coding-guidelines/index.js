...
//
// Syntax (documented in .ai-memory/coding-guidelines.md):
...
const preferFunctionLines = {
  meta: {
    ...
    messages: {
      tooLong: '🔴 CODE-RED-005: Function "{{name}}" has {{actual}} effective lines (max {{prefer}}). Extract helpers — strict 8-line cap per .ai-memory/coding-guidelines.md rule #1.',
    },
    schema: [{
      type: "object",
      properties: {
