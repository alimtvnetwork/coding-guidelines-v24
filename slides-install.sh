...
BUNDLE_NAME="slides"
BUNDLE_MAPPING="spec-slides|spec-slides slides-app|slides-app version.json|version.json .lovable/what-to-read.md|.lovable/what-to-read.md"
