...
BUNDLE_NAME="slides"
BUNDLE_MAPPING="spec-coding-guideline|spec-coding-guideline slides-app|slides-app version.json|version.json .lovable/what-to-read.md|.lovable/what-to-read.md .lovable/memory|.lovable/memory"
