...
#   spec-coding-guideline → spec-coding-guideline
...
__INSTALLER_LOG_FILE="$__INSTALLER_LOG_DIR/slides-install-$(date -u +%Y%m%dT%H%M%SZ).log"
{
    echo "# slides-install crash log"
...
__installer_on_err() {
    ...
    local cmd=${2:-?}
    {
        echo ""
        echo "════════════════════════════════════════════════════════"
        echo "  ❌ slides-install FAILED (exit $rc) at line $line"
        echo "     command: $cmd"
        echo "  ────────────────────────────────────────────────────"
...
BUNDLE_NAME="slides"
BUNDLE_MAPPING="spec-coding-guideline|spec-coding-guideline slides-app|slides-app version.json|version.json .ai-memory/what-to-read.md|.ai-memory/what-to-read.md .ai-memory/memory|.ai-memory/memory"
...
PREBUILT_SRC="slides-app/dist"
PREBUILT_DEST="slides-app/dist"
VERIFY_PAIRS="slides-app/dist/index.html|file spec-slides|dir"
