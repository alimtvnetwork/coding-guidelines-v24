...
Updated all references from `coding-guidelines-v19` to `coding-guidelines-v19` across distribution and CI/CD specifications.

#### Changed
- Install scripts, CI templates, and release pipelines now reference `coding-guidelines-v19` repository slug
