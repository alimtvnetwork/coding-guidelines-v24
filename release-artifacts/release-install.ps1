...
.DESCRIPTION
    ...
    RESOLUTION ORDER (highest precedence first, spec §4.3):
      ...
      3. v6.6.0 baked at release-asset build time
...
# The release workflow replaces v6.6.0 with the concrete
