...
# The release workflow replaces v6.35.2 with the concrete
# tag (e.g. v3.21.0) when uploading this file as a release asset.
$BakedVersion = "v6.35.2"
