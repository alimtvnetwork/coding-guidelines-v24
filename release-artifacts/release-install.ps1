...
.DESCRIPTION
    ...
    RESOLUTION ORDER (highest precedence first, spec §4.3):
      ...
      3. v6.9.1 baked at release-asset build time
...
# The release workflow replaces v6.9.1 with the concrete
