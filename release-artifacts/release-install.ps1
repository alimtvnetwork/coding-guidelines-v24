...
# The release workflow replaces v4.24.0 with the concrete
# tag (e.g. v3.21.0) when uploading this file as a release asset.
$BakedVersion = "v4.24.0"
