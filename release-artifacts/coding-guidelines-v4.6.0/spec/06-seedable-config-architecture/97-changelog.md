...
Updated all references from `coding-guidelines-v14` to `coding-guidelines-v18` across distribution and CI/CD specifications.

#### Changed
- Install scripts, CI templates, and release pipelines now reference `coding-guidelines-v18` repository slug
