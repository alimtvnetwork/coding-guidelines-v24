...
Updated all references from `coding-guidelines-v22` to `coding-guidelines-v22` across distribution and CI/CD specifications.

#### Changed
- Install scripts, CI templates, and release pipelines now reference `coding-guidelines-v22` repository slug
