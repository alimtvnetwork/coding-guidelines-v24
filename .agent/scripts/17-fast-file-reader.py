...
Usage:
  python .lovable/ai-fix-scripts/17-fast-file-reader.py --list-folder <folder_path> [--ext .md,.ts]
  python .lovable/ai-fix-scripts/17-fast-file-reader.py --read-file <file_path> [--max-bytes 50000]
