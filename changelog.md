...
### Added
- feat(prompts): integrate GitMap pipeline-ai and dynamic waiting protocol
...
### Changed — feat(prompts): integrate GitMap pipeline-ai and dynamic waiting protocol

- Bumped `package.json` from `6.41.0` → `6.42.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`
...
### Changed — sync banned operation checklists, os enum detector, and atomic test inventory tracking

- Bumped `package.json` from `6.38.0` → `6.39.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`
...
### Changed — Tracer OS temp backup and recycle bin, single-file guideline checklist, audit purge

- Bumped `package.json` from `6.37.0` → `6.38.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`
...
### Changed — Package architecture, streaming writers, base enums, and comment cleanup

- Bumped `package.json` from `6.35.3` → `6.36.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`
...
- Bumped `package.json` from `6.35.2` → `6.35.3`.
...
- Bumped `package.json` from `6.35.1` → `6.35.2`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
### Changed — Convert codegen CI verifiers to Python & fix fixture determinism drift

- Bumped `package.json` from `6.34.0` → `6.35.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
### Changed — Fix installer template literal SyntaxError & enhance fast Python tooling

- Bumped `package.json` from `6.34.0` → `6.34.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `public/health-score.json`
...
- Bumped `package.json` from `6.33.2` → `6.33.3`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.33.1` → `6.33.2`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.33.0` → `6.33.1`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.32.0` → `6.33.0`.
...
- Bumped `package.json` from `6.31.0` → `6.32.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.30.0` → `6.31.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.29.0` → `6.30.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.28.0` → `6.29.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.27.0` → `6.28.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.26.0` → `6.27.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.25.0` → `6.26.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.24.0` → `6.25.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.23.0` → `6.24.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.22.0` → `6.23.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.21.0` → `6.22.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.18.0` → `6.18.1`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.17.0` → `6.18.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.15.0` → `6.16.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.13.3` → `6.14.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Major version bump to `6.0.0` per user directive. No breaking API changes in scripts or CI contracts; the bump marks the completion of the v5.13x hardening cycle (Hard Rule #6 enforcement, guideline mirror drift detection, branch-protection nightly drift, sync auto-fix workflow, drift report artifacts).
- `scripts/sync-check.mjs` refactored from 416 lines to 202 lines by extracting `scripts/lib/sync-check-normalisers.mjs` and `scripts/lib/sync-check-report.mjs`. Restores compliance with Hard Rule #6 (300-line file cap) without any behavior change: same flags (`--verbose`, `--fix`, `--report <dir>`), same exit codes (0/1/2), same normaliser semantics.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`, `src/data/specTree.json`.

---

### Changed — CI sync auto-fix workflow and drift report artifact

- Bumped `package.json` from `5.131.0` → `5.132.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Slide 59 `slides-app/src/slides/59-a11y-floor.tsx` (`A11Y-001`, hard). Chapter H opener: WCAG 2.2 AA is the shipping floor for every UI. Ten non-negotiable minimums: keyboard reach, visible focus, programmatic labels, 4.5:1 contrast, no color-only info, reduced-motion respect, modal focus trap + restore, live regions, alt text, sequential headings, 24x24 hit targets. Enforced by `axe-core` in CI (existing since v5.54.0), `eslint-plugin-jsx-a11y` strict, Storybook a11y addon, and a design-token contrast gate.
...
- Verification: `node scripts/validate-slides-sra.mjs` reports "OK: 21 slide(s)" (was 20). Palette search `trust`, `isolation`, `02-spec/19`, or `one-way` returns the new slide.
...
- Rendered 20 new PNGs across `02-spec/**/{diagrams,images}/`; 26 total baseline PNGs now committed.
...
- Spec-only closure per `mem://constraints/spec19-no-implementation` — no mutation framework wired inside `02-spec/`.
...
- **Free-text-column rule family — extracted shared logic** into
  ...
  - `DB-FREETEXT-001` → v1.1.0 — **presence only**, no waivers (preserves
    v1.0 behavior for existing CI configs).
...
- **Spec tree audit (115 violations → 0 unwaived).** Every `CREATE TABLE`
  inside ` ```sql ` markdown fences across `02-spec/` was audited against
  Rules 10/11/12.
...
- Bumped `package.json` from `6.18.1` → `6.18.2`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `src/data/specTree.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.19.0` → `6.20.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
...
- Bumped `package.json` from `6.18.2` → `6.19.0`.
- Sync-managed artifacts regenerated by `npm run sync`: `version.json`, `public/health-score.json`, `readme.md`, `docs/architecture.md`, `docs/principles.md`, `docs/author.md`
