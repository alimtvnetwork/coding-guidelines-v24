...
#   .lovable/strictly-avoid.md → .lovable/strictly-avoid.md
#
...
echo "════════════════════════════════════════════════════════"
echo "  📦 consolidated-install v6.35.3"
echo "     mode:    ${MODE}"
echo "     repo:    ${REPO_SLUG}"
if [[ -n "${LOCAL_ARCHIVE}" ]]; then
