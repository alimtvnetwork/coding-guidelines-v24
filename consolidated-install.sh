...
#   .ai-memory/what-to-read.md → .ai-memory/what-to-read.md
#   .ai-memory/memory → .ai-memory/memory
#   .ai-memory/coding-guidelines.md → .ai-memory/coding-guidelines.md
#   01-prompts → 01-prompts
#   03-ai-scripts → 03-ai-scripts
#   .ai-memory/plans → .ai-memory/plans
#   .ai-memory/issues → .ai-memory/issues
#   .ai-memory/cicd-issues → .ai-memory/cicd-issues
#   .agents/skills → .agents/skills
#   .agents/scripts → .agents/scripts
#   .ai-memory/strictly-avoid.md → .ai-memory/strictly-avoid.md
#
...
{
    echo "# consolidated-install crash log"
...
__installer_on_err() {
    ...
    local cmd=${2:-?}
    {
        echo ""
        echo "════════════════════════════════════════════════════════"
        echo "  ❌ consolidated-install FAILED (exit $rc) at line $line"
        echo "     command: $cmd"
        echo "  ────────────────────────────────────────────────────"
...
BUNDLE_MAPPING="02-spec/01-spec-authoring-guide|02-spec/01-spec-authoring-guide 02-spec/03-error-manage|02-spec/03-error-manage 02-spec/17-consolidated-guidelines|02-spec/17-consolidated-guidelines version.json|version.json .ai-memory/what-to-read.md|.ai-memory/what-to-read.md .ai-memory/memory|.ai-memory/memory .ai-memory/coding-guidelines.md|.ai-memory/coding-guidelines.md 01-prompts|01-prompts 03-ai-scripts|03-ai-scripts .ai-memory/plans|.ai-memory/plans .ai-memory/issues|.ai-memory/issues .ai-memory/cicd-issues|.ai-memory/cicd-issues .agents/skills|.agents/skills .agents/scripts|.agents/scripts .ai-memory/strictly-avoid.md|.ai-memory/strictly-avoid.md"
...
echo "════════════════════════════════════════════════════════"
echo "  📦 consolidated-install v6.44.0"
echo "     mode:    ${MODE}"
echo "     repo:    ${REPO_SLUG}"
if [[ -n "${LOCAL_ARCHIVE}" ]]; then
