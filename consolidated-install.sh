...
BUNDLE_MAPPING="spec/01-spec-authoring-guide|spec/01-spec-authoring-guide spec/03-error-manage|spec/03-error-manage spec/17-consolidated-guidelines|spec/17-consolidated-guidelines version.json|version.json .lovable/what-to-read.md|.lovable/what-to-read.md"
...
echo "════════════════════════════════════════════════════════"
echo "  📦 consolidated-install v6.13.3"
echo "     mode:    ${MODE}"
echo "     repo:    ${REPO_SLUG}"
if [[ -n "${LOCAL_ARCHIVE}" ]]; then
