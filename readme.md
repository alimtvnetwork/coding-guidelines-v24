<p align="center">
  <a href="https://github.com/alimtvnetwork/coding-guidelines-v23">
    <img
...
<p align="center">
  <!-- STAMP:BADGES --><a href="https://github.com/alimtvnetwork/coding-guidelines-v23/releases"><img alt="Version" src="https://img.shields.io/badge/version-5.44.0-3B82F6?style=flat-square"/></a> <a href="LICENSE"><img alt="License" src="https://img.shields.io/badge/license-MIT-22C55E?style=flat-square"/></a> <a href="llm.md"><img alt="AI Ready" src="https://img.shields.io/badge/AI%20ready-yes-FF6E3C?style=flat-square"/></a><!-- /STAMP:BADGES -->
</p>
...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->5.44.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-05-07<!-- /STAMP:UPDATED -->
</p>
...
```powershell
& ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/install.ps1))) -n
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/install.sh | bash -s -- -n
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/error-manage-install.ps1 | iex
```

### 🐧 macOS · Linux · Bash

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/error-manage-install.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/splitdb-install.ps1 | iex
```

### 🐧 macOS · Linux · Bash

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/splitdb-install.sh | bash
```

### <code>slides</code>, Slides App + Decks

<p align="center">
  <a href="https://github.com/alimtvnetwork/coding-guidelines-v23/releases/latest">
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/slides-install.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/linters-install.ps1 | iex
```

### 🐧 macOS · Linux · Bash

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/linters-install.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/cli-install.ps1 | iex
```

### 🐧 macOS · Linux · Bash

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/cli-install.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/wp-install.ps1 | iex
```

### 🐧 macOS · Linux · Bash

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/wp-install.sh | bash
```
...
```powershell
irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/consolidated-install.ps1 | iex
```

### 🐧 macOS · Linux · Bash

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/consolidated-install.sh | bash
```
...
```bash
curl -fsSL https://github.com/alimtvnetwork/coding-guidelines-v23/releases/download/v3.79.0/install.sh | bash -s -- -v v3.79.0
```
...
& ([scriptblock]::Create((irm https://github.com/alimtvnetwork/coding-guidelines-v23/releases/latest/download/install.ps1))) -Version v3.79.0
...
& ([scriptblock]::Create((irm https://github.com/alimtvnetwork/coding-guidelines-v23/releases/latest/download/install.ps1))) -Help
```
...
When this repo bumps its major version (e.g. `coding-guidelines-v23` → `coding-guidelines-v23`), use `fix-repo` to rewrite prior versioned-repo-name tokens across all tracked text files. The script auto-detects the base name and current version from `git remote get-url origin`, nothing is hardcoded.
...
Token form: `{RepoBase}-v{N}` (e.g. `coding-guidelines-v23`). URLs are preserved automatically, only the token segment changes. A numeric-overflow guard prevents `coding-guidelines-v23` from matching inside `coding-guidelines-v170`. Full normative spec: [`spec-authoring/22-fix-repo/01-spec.md`](spec-authoring/22-fix-repo/01-spec.md).
