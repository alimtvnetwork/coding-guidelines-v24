...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->v6.43.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-09-19<!-- /STAMP:UPDATED -->
  <!-- STAMP:FILES -->700<!-- /STAMP:FILES -->
  <!-- STAMP:LINES -->149,525<!-- /STAMP:LINES -->
</p>
