...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->6.18.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-08-25<!-- /STAMP:UPDATED -->
  <!-- STAMP:FILES -->707<!-- /STAMP:FILES -->
  <!-- STAMP:LINES -->146,937<!-- /STAMP:LINES -->
</p>
