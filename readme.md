...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->6.33.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-08-29<!-- /STAMP:UPDATED -->
  <!-- STAMP:FILES -->711<!-- /STAMP:FILES -->
  <!-- STAMP:LINES -->151,033<!-- /STAMP:LINES -->
</p>
