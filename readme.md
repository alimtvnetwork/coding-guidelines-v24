...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FILES -->614<!-- /STAMP:FILES --> spec files · <!-- STAMP:FOLDERS -->22<!-- /STAMP:FOLDERS --> top-level folders · <!-- STAMP:LINES -->132,679<!-- /STAMP:LINES --> lines · v<!-- STAMP:VERSION -->4.24.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-04-27<!-- /STAMP:UPDATED -->
</p>
