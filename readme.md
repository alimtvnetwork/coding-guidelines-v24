...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->6.18.2<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-08-26<!-- /STAMP:UPDATED -->
  <!-- STAMP:FILES -->707<!-- /STAMP:FILES -->
  <!-- STAMP:LINES -->149,440<!-- /STAMP:LINES -->
</p>
