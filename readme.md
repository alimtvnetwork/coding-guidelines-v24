...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->6.44.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-09-22<!-- /STAMP:UPDATED -->
  <!-- STAMP:FILES -->700<!-- /STAMP:FILES -->
  <!-- STAMP:LINES -->149,773<!-- /STAMP:LINES -->
</p>
