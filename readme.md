...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->6.23.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-08-27<!-- /STAMP:UPDATED -->
  <!-- STAMP:FILES -->707<!-- /STAMP:FILES -->
  <!-- STAMP:LINES -->149,495<!-- /STAMP:LINES -->
</p>
