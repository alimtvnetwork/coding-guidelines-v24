...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FILES -->622<!-- /STAMP:FILES --> spec files · <!-- STAMP:FOLDERS -->22<!-- /STAMP:FOLDERS --> top-level folders · <!-- STAMP:LINES -->133,880<!-- /STAMP:LINES --> lines · v<!-- STAMP:VERSION -->5.2.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-04-30<!-- /STAMP:UPDATED -->
</p>
