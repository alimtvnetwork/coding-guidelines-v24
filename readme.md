...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->6.46.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-09-24<!-- /STAMP:UPDATED -->
  <!-- STAMP:FILES -->718<!-- /STAMP:FILES -->
  <!-- STAMP:LINES -->154,126<!-- /STAMP:LINES -->
</p>
