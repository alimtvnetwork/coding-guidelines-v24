...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->6.35.2<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-08-31<!-- /STAMP:UPDATED -->
  <!-- STAMP:FILES -->693<!-- /STAMP:FILES -->
  <!-- STAMP:LINES -->148,868<!-- /STAMP:LINES -->
</p>
