...
<p align="center">
  <em>Stats:</em> <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders · v<!-- STAMP:VERSION -->6.1.0<!-- /STAMP:VERSION --> · updated <!-- STAMP:UPDATED -->2026-08-09<!-- /STAMP:UPDATED -->
</p>
