...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v22/main/error-manage-install.ps1))) -Version v5.11.0 -Target .\vendor
#>
...
Write-Host "  📦 error-manage-install v5.11.0" -ForegroundColor Cyan
