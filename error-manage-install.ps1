...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/error-manage-install.ps1))) -Version v6.18.0 -Target .\vendor
#>
...
Write-Host "  📦 error-manage-install v6.18.0" -ForegroundColor Cyan
