...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/error-manage-install.ps1))) -Version v6.20.0 -Target .\vendor
#>
...
Write-Host "  📦 error-manage-install v6.20.0" -ForegroundColor Cyan
