...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v16/main/error-manage-install.ps1))) -Version v3.77.0 -Target .\vendor
#>
