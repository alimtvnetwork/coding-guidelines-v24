...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v20/main/error-manage-install.ps1))) -Version v5.8.0 -Target .\vendor
#>
...
Write-Host "  📦 error-manage-install v5.8.0" -ForegroundColor Cyan
