...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v23/main/error-manage-install.ps1))) -Version v5.11.0 -Target .\vendor
#>
