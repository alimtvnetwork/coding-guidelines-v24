...
BUNDLE_NAME="wp"
BUNDLE_MAPPING="spec/18-wp-plugin-how-to|spec/18-wp-plugin-how-to version.json|version.json .lovable/what-to-read.md|.lovable/what-to-read.md"
