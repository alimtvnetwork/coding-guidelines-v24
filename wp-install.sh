...
__INSTALLER_LOG_FILE="$__INSTALLER_LOG_DIR/wp-install-$(date -u +%Y%m%dT%H%M%SZ).log"
{
    echo "# wp-install crash log"
...
__installer_on_err() {
    ...
    local cmd=${2:-?}
    {
        echo ""
        echo "════════════════════════════════════════════════════════"
        echo "  ❌ wp-install FAILED (exit $rc) at line $line"
        echo "     command: $cmd"
        echo "  ────────────────────────────────────────────────────"
...
BUNDLE_NAME="wp"
BUNDLE_MAPPING="02-spec/18-wp-plugin-how-to|02-spec/18-wp-plugin-how-to version.json|version.json .ai-memory/what-to-read.md|.ai-memory/what-to-read.md .ai-memory/memory|.ai-memory/memory"
