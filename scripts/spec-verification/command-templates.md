...
| `lint:spec-folders` | Every spec folder has the required readme.md and follows kebab-case numeric prefixes. | `python3 linter-scripts/check-spec-folder-refs.py` |
