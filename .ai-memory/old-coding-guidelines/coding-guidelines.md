...
**Before reading the rules below**, read the [AI Instruction Manual & Overview](02-spec/02-coding-guidelines/01-cross-language/readme.md) to understand how to review code, interpret files, and maintain repository hygiene (e.g. updating `.gitignore`).
...
> NOTE: Conflict with folder-level `02-spec/02-coding-guidelines/`, `02-spec/02-coding-guidelines/`, `02-spec/03-error-manage` or similar guideline folders. The folder-level spec wins over this file if those exist.
