...
BUNDLE_MAPPING="02-spec/01-spec-authoring-guide|02-spec/01-spec-authoring-guide 02-spec/03-error-manage|02-spec/03-error-manage version.json|version.json .ai-memory/what-to-read.md|.ai-memory/what-to-read.md .ai-memory/memory|.ai-memory/memory"
...
echo "════════════════════════════════════════════════════════"
echo "  📦 error-manage-install v6.44.0"
echo "     mode:    ${MODE}"
echo "     repo:    ${REPO_SLUG}"
if [[ -n "${LOCAL_ARCHIVE}" ]]; then
