...
BUNDLE_MAPPING="spec/01-spec-authoring-guide|spec/01-spec-authoring-guide spec/03-error-manage|spec/03-error-manage version.json|version.json .lovable/what-to-read.md|.lovable/what-to-read.md"
...
echo "════════════════════════════════════════════════════════"
echo "  📦 error-manage-install v6.18.0"
echo "     mode:    ${MODE}"
echo "     repo:    ${REPO_SLUG}"
if [[ -n "${LOCAL_ARCHIVE}" ]]; then
