...
BUNDLE_NAME="splitdb"
BUNDLE_MAPPING="spec/04-database-conventions|spec/04-database-conventions spec/05-split-db-architecture|spec/05-split-db-architecture spec/06-seedable-config-architecture|spec/06-seedable-config-architecture version.json|version.json .lovable/what-to-read.md|.lovable/what-to-read.md"
