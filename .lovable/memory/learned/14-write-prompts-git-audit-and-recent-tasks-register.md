...
This document formalizes the architectural decisions, user directives, and operational protocols governing the upgrade of the memory-writing workflows (`01-write-antigravity.md` and `03-write-memory.md`) to Version 2.2.0. The upgrade mandates an audit of the last 30 Git commits before authoring memory, institutes a compact 20-task recent completion register in `.lovable/plans/01-index.md`, and establishes a 19-box verification checklist before turn completion.
...
- **Solution:** A rolling, compact **Recent Completed Tasks Register (Last 20 Tasks)** embedded directly in `.lovable/plans/01-index.md`.
- **Requirements:**
  ...
  3. `.lovable/what-to-read.md` references this register under "Before any task (always)".
...
- **Recent Tasks Status (Last 20 Tasks):** Compact review of the 20 tasks in `.lovable/plans/01-index.md` vs remaining pending tasks.
...
2. 20-task status register audit in `.lovable/plans/01-index.md`.
3. Pre-flight recursive walk of `.lovable/`.
...
- **Master Memory Index:** `.lovable/memory/01-index.md`
- **Master Plans Index:** `.lovable/plans/01-index.md`
- **Canonical Reading Sequence:** `.lovable/what-to-read.md`
