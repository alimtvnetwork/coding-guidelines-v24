...
When a `return` statement is preceded by other statements in the same block, insert exactly **one** blank line before it. (This matches `release-artifacts/coding-guidelines-v24.4.0/spec/02-coding-guidelines/01-cross-language/04-code-style/03-blank-lines-and-spacing.md`, Rule 4.)
