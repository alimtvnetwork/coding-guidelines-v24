...
### Repo slug rebrand to `coding-guidelines-v19` — 2026-04-24
- Full sweep of `release-artifacts/release-install.{ps1,sh}` and downstream docs. Canonical slug now `alimtvnetwork/coding-guidelines-v19`.
