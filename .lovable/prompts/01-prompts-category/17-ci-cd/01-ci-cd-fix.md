...
> [!IMPORTANT]
> **This entire phase is dedicated to one goal ONLY: creating `.lovable/ai-fix-scripts/06-cicd-local-runner.py`.**
...
Run `.lovable/ai-fix-scripts/05-guideline-autofixer.py` on all modified files, then verify:
