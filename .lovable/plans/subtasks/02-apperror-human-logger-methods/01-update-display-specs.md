...
6. Update spec/03-error-manage/02-error-architecture/06-apperror-package/09-ai-action-plan-apperror-methods.md to instruct the AI to write these specific formatting methods.
