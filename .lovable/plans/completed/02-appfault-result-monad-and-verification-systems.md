...
- [`.lovable/memory/learned/04-streamwriter-contracts-and-naming-standards.md`](.lovable/memory/learned/04-streamwriter-contracts-and-naming-standards.md) — Monadic `Bytes[T]`, `WrappedBytes`, and error wrapping conventions.
