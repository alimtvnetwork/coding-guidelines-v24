...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/wp-install.ps1))) -Version v6.18.1 -Target .\vendor
#>
...
$BundleName = "wp"
$BundleMapping = "spec/18-wp-plugin-how-to|spec/18-wp-plugin-how-to,version.json|version.json,.lovable/what-to-read.md|.lovable/what-to-read.md"
...
Write-Host "  📦 wp-install v6.18.1" -ForegroundColor Cyan
