...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v18/main/wp-install.ps1))) -Version v4.24.0 -Target .\vendor
#>
...
Write-Host "  📦 wp-install v4.24.0" -ForegroundColor Cyan
