...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v22/main/wp-install.ps1))) -Version v5.11.0 -Target .\vendor
#>
...
Write-Host "  📦 wp-install v5.11.0" -ForegroundColor Cyan
