...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v19/main/consolidated-install.ps1))) -Version v5.2.0 -Target .\vendor
#>
...
Write-Host "  📦 consolidated-install v5.2.0" -ForegroundColor Cyan
