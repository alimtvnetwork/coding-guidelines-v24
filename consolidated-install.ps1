...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/consolidated-install.ps1))) -Version v6.13.2 -Target .\vendor
#>
...
$BundleMapping = "spec/01-spec-authoring-guide|spec/01-spec-authoring-guide,spec/03-error-manage|spec/03-error-manage,spec/17-consolidated-guidelines|spec/17-consolidated-guidelines,version.json|version.json,.lovable/what-to-read.md|.lovable/what-to-read.md"
...
Write-Host "  📦 consolidated-install v6.13.2" -ForegroundColor Cyan
