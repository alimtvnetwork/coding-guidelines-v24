...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/consolidated-install.ps1))) -Version v6.32.0 -Target .\vendor
#>
...
Write-Host "  📦 consolidated-install v6.32.0" -ForegroundColor Cyan
