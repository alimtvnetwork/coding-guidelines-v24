#!/usr/bin/env python3
"""CODE-RED-013 - Inverted Complex Conditions. TypeScript."""
...
def main() -> int:
    args = build_parser("CODE-RED-013 inverted-complex-conditions (TS)").parse_args()
    _globs = parse_exclude_paths(args.exclude_paths)
    run = SarifRun(tool_name="coding-guidelines-invert-cond-ts", tool_version="1.0.0", rules=[RULE])
