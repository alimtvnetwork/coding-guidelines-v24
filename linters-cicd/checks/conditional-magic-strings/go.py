#!/usr/bin/env python3
"""CODE-RED-009 - Conditional magic strings. Go. Flags magic strings used in if/else if conditions."""
...
def main() -> int:
    args = build_parser("CODE-RED-009 conditional-magic-strings (Go)").parse_args()
    _globs = parse_exclude_paths(args.exclude_paths)
    run = SarifRun(tool_name="coding-guidelines-conditional-magic-strings-go", tool_version="1.0.0", rules=[RULE])
