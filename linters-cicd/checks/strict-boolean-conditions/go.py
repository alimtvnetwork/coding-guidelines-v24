#!/usr/bin/env python3
"""CODE-RED-014 - Strict Boolean Conditions. Go."""
...
def main() -> int:
    args = build_parser("CODE-RED-014 strict-boolean-conditions (Go)").parse_args()
    _globs = parse_exclude_paths(args.exclude_paths)
    run = SarifRun(tool_name="coding-guidelines-strict-bool-go", tool_version="1.0.0", rules=[RULE])
