...
**Spec:** [`02-spec/04-database-conventions/03-schema-design.md`](../../../02-spec/04-database-conventions/03-schema-design.md) §6 (v3.4.0)
**Naming source:** [`02-naming-conventions.md`](../../../02-spec/04-database-conventions/03-naming-conventions.md) Rules 10 / 11 / 12 (v3.5.0)
