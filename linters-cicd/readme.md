...
> **Spec:** [`02-spec/02-coding-guidelines/06-cicd-integration/`](../02-spec/02-coding-guidelines/06-cicd-integration/readme.md)
...
| Channel | How |
|---------|-----|
| GitHub composite Action | `uses: alimtvnetwork/coding-guidelines-v24/linters-cicd@vX.Y.Z` |
