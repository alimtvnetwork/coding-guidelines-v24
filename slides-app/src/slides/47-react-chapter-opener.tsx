 ...
 *
 * Source: spec/17/31 lines 97-112. Effects are last resort, types are named,
...
export default function ReactChapterOpenerSlide() {
  return (
    <SlideLayout
      ...
      subtitle="The next 13 slides enforce spec/17/31 lines 97-112: guard effects behind positive booleans, ban tuple public shapes, keep components under 100 lines, and give every generic and prop bag a real name. This slide is the map: it lists what changes and why."
    >
