...
export default function StableUniqueKeysSlide() {
  return (
    <SlideLayout
      ...
      subtitle="02-spec/17/31 line 106: lists must have stable, unique `key` props derived from data, never the array index unless the list is truly static. Keys tell React which DOM node maps to which item across renders."
    >
