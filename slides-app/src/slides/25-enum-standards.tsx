 ...
 *
 * Source: 02-spec/17/31 line 31 (no magic strings), line 168 (Go `type X byte`
    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 18, marginTop: 4 }}>
        ...
        <ActionPanel
          ...
          rule="Every finite set of values is a PascalCase enum type with PascalCase members. TS uses `enum`, Go uses `type X byte` plus `iota`, PHP uses backed enums with an `isEqual` method. Parsing external input goes through a strict `ParseX` / `TryFromValue` that returns an error on unknown values. No string literal comparisons at call sites. Per 02-spec/17/31 lines 31, 168, 171."
