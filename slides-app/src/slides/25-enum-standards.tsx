    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 18, marginTop: 4 }}>
        ...
        <ActionPanel
          ...
          symptom="You grep for `\"ready\"` and find it in 14 files across TS, Go, and PHP. A typo `\"redy\"` silently branches to the false path. Renaming the state requires a full-repo find-and-replace and still misses stringly-typed JSON boundaries."
