    ...
    >
      <div style={{ display: "flex", flexDirection: "column", gap: 18, marginTop: 4 }}>
        ...
        <ActionPanel
          ...
          rule="No boolean flag parameters. Split the function into two (or more) positively named functions, one per branch. `render(true)` is wrong; `renderExpanded()` and `renderCollapsed()` are right. Per 02-spec/17/31 line 48."
