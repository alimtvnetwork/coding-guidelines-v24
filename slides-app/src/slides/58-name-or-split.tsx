...
export default function NameOrSplitSlide() {
  return (
    <SlideLayout
      ...
      subtitle="02-spec/17/31 line 112: as the author (human or AI), invent the clearest domain name for each type. Naming failure is a comprehension failure. Splitting is the fix, never `Data`, `Info`, `Config`, `Payload`, `Params`, `Options`, or `Thing`."
    >
