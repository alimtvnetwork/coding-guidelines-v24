...
export default function TypesFileColocationSlide() {
  return (
    <SlideLayout
      ...
      subtitle="02-spec/17/31 line 111: prop types and event handler types live in a dedicated `types.ts` next to the component, or in `src/types/` when shared. Extraction keeps components under the 100-line cap and makes prop shapes greppable, importable, and stable across refactors."
    >
