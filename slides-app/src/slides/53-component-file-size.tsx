...
export default function ComponentFileSizeSlide() {
  return (
    <SlideLayout
      ...
      subtitle="spec/17/31 line 107: keep component files under 100 lines. 100 is a smoke alarm, not a fire code. It fires before the file becomes unreviewable, unmergeable, and untestable, at exactly the moment extraction is cheap."
    >
