...
export default function CustomHookShapeSlide() {
  return (
    <SlideLayout
      ...
      subtitle="spec/17/31 line 108: custom hooks start with `use`, return a named object type (never a bare tuple), and never call other hooks conditionally. The `use` prefix is how React and its lint rules recognize hook call sites; the named return is how call sites stay readable when the shape grows."
    >
