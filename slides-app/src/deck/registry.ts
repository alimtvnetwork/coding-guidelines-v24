...
export const DECK: readonly SlideEntry[] = [
  ...
  { id: "23-boolean-naming", title: "Boolean naming · is/has only, positive only", section: "naming", severity: "hard", ruleId: "BOOL-002", tags: ["boolean", "is", "has", "can", "should", "positive framing", "negation"], component: BooleanNaming },
