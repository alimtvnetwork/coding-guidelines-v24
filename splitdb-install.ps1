...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/splitdb-install.ps1))) -Version v6.46.0 -Target .\vendor
#>
...
Write-Host "  📦 splitdb-install v6.46.0" -ForegroundColor Cyan
