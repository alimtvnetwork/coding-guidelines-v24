...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v19/main/splitdb-install.ps1))) -Version v5.1.0 -Target .\vendor
#>
...
Write-Host "  📦 splitdb-install v5.1.0" -ForegroundColor Cyan
