...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v18/main/splitdb-install.ps1))) -Version v4.24.0 -Target .\vendor
#>
...
Write-Host "  📦 splitdb-install v4.24.0" -ForegroundColor Cyan
