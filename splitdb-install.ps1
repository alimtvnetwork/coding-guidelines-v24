...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/splitdb-install.ps1))) -Version v6.18.1 -Target .\vendor
#>
...
$BundleName = "splitdb"
$BundleMapping = "spec/04-database-conventions|spec/04-database-conventions,spec/05-split-db-architecture|spec/05-split-db-architecture,spec/06-seedable-config-architecture|spec/06-seedable-config-architecture,version.json|version.json,.lovable/what-to-read.md|.lovable/what-to-read.md"
...
Write-Host "  📦 splitdb-install v6.18.1" -ForegroundColor Cyan
