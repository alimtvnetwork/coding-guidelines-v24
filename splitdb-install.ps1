...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/splitdb-install.ps1))) -Version v3.77.0 -Target .\vendor
#>
...
Write-Host "  📦 splitdb-install v3.77.0" -ForegroundColor Cyan
