...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/cli-install.ps1))) -Version v3.77.0 -Target .\vendor
#>
...
Write-Host "  📦 cli-install v3.77.0" -ForegroundColor Cyan
