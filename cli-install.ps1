...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/cli-install.ps1))) -Version v6.18.1 -Target .\vendor
#>
...
Write-Host "  📦 cli-install v6.18.1" -ForegroundColor Cyan
