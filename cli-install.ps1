...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/cli-install.ps1))) -Version v6.35.3 -Target .\vendor
#>
...
Write-Host "  📦 cli-install v6.35.3" -ForegroundColor Cyan
