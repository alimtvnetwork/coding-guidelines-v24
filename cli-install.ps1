...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v20/main/cli-install.ps1))) -Version v5.4.0 -Target .\vendor
#>
...
Write-Host "  📦 cli-install v5.4.0" -ForegroundColor Cyan
