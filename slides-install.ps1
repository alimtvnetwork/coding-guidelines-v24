...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v16/main/slides-install.ps1))) -Version v4.7.0 -Target .\vendor
#>
...
Write-Host "  📦 slides-install v4.7.0" -ForegroundColor Cyan
