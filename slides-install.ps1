...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/slides-install.ps1))) -Version v6.27.0 -Target .\vendor
#>
...
Write-Host "  📦 slides-install v6.27.0" -ForegroundColor Cyan
