...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v16/main/slides-install.ps1))) -Version v3.77.0 -Target .\vendor
#>
...
Write-Host "  📦 slides-install v3.77.0" -ForegroundColor Cyan
