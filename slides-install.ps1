...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/slides-install.ps1))) -Version v6.35.3 -Target .\vendor
#>
...
$BundleName = "slides"
$BundleMapping = "spec-coding-guideline|spec-coding-guideline,slides-app|slides-app,version.json|version.json,.lovable/what-to-read.md|.lovable/what-to-read.md,.lovable/memory|.lovable/memory"
...
Write-Host "  📦 slides-install v6.35.3" -ForegroundColor Cyan
