...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v22/main/slides-install.ps1))) -Version v5.11.0 -Target .\vendor
#>
...
$ReleaseBase = "https://github.com/alimtvnetwork/coding-guidelines-v22/releases"
$RepoSlug = "alimtvnetwork/coding-guidelines-v22"
...
Write-Host "  📦 slides-install v5.11.0" -ForegroundColor Cyan
