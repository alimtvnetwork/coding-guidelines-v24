...
Updated all references from `coding-guidelines-v23` to `coding-guidelines-v23` across distribution and CI/CD specifications.

#### Changed
- Install scripts, CI templates, and release pipelines now reference `coding-guidelines-v23` repository slug
