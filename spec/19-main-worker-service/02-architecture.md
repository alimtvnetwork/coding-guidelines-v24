...
Both Main and Worker consume **Seedable-Config** (per `spec/06-seedable-config-architecture/`). For terminology mapping (including replaced legacy terms), see `03-glossary.md` §Reserved.
