...
>
> - All `*At` timestamp columns are now `INTEGER` (epoch seconds, UTC) per `spec/04-database-conventions/03-naming-conventions.md` Rule 7.1 v2.
...
| `CorrelationId` | TEXT | NO | Echoes the inbound `X-Correlation-Id` header per `spec/04-database-conventions/07-rest-api-format.md` |
