...
2. **Threat-model document** at `spec/19-main-worker-service/25-threat-model.md` (does not yet exist — placeholder slot 24 is reserved by this clause).
...
- `spec/19-main-worker-service/06-auth-and-2fa.md` — high-level auth contract.
- `spec/19-main-worker-service/07-core-api-endpoints.md` §3.2 — `/Resolve` response shape.
- `spec/19-main-worker-service/11-worker-bootstrap-protocol.md` §3.2 — `JwtPublicKeyPem` + `JwtSigningKeyId` source.
