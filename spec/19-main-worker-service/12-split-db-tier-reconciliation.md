...
%% Tier mapping for this spec: spec/19-main-worker-service/12-split-db-tier-reconciliation.md
...
| FU-6 | Back-link from `spec/05` | `spec/05-split-db-architecture/02-fundamentals.md` | ⏭ Out of scope for spec/19 — tracked in spec/05 |

---

## 7. Cross-references

- `spec/05-split-db-architecture/02-fundamentals.md` — source of truth for all tier semantics.
- `spec/19-main-worker-service/04-main-db-schema.md` — Main-side schema, post-FU-2.
- `spec/19-main-worker-service/11-worker-bootstrap-protocol.md` — uses §4 provisioning order.
