...
"Tables": {
  ...
  "AuthMechanism": {
    ...
    "Rows": [
      ...
      { "AuthMechanismCode": "Jwt",     "AuthMechanismLabel": "Worker JWT (RS256)",          "Description": "Per spec/19/13-jwt-delivery-contract.md." },
...
- `spec/19-main-worker-service/08-role-based-dashboards.md` — consumer of `Role`/`AccessItem`/`RoleAccessItem`.
- `spec/19-main-worker-service/11-worker-bootstrap-protocol.md` §8 — consumer of `WorkerNodeStatus`.
- `spec/19-main-worker-service/07-core-api-endpoints.md` §5 — consumer of `AuthMechanism`.
- `spec/19-main-worker-service/12-split-db-tier-reconciliation.md` §4 — tier placement.
