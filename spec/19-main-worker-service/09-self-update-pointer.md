...
1. Confirm `spec/14-update/` covers every behaviour summarised in §3 of this file. Diff §3 against `spec/14-update/01-index.md` — any remaining gap blocks deletion.
2. Migrate any inbound links pointing at this file (search: `09-self-update-pointer.md`) to the equivalent anchor in `spec/14-update/`. Update `01-index.md`, `plan.md`, `99-consistency-report.md`, `98-changelog.md`, and the diagrams' authority footers.
