...
>
> For CI-pipeline issues (lint, test, build matrix), see [`spec/12-cicd-pipeline-workflows/17-release-pipeline-issues-rca.md`](../12-cicd-pipeline-workflows/17-release-pipeline-issues-rca.md).
...
- [spec/14-update/12-windows-icon-embedding.md](../14-update/12-windows-icon-embedding.md) — winres icon post-mortem
- [spec/17-consolidated-guidelines/18-cicd-pipeline-workflows.md](../17-consolidated-guidelines/18-cicd-pipeline-workflows.md) — Consolidated CI/CD guidelines
