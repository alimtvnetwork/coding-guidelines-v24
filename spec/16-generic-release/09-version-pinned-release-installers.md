...
[04-install-scripts.md §OS and Architecture Detection](04-install-scripts.md).
...
1. Update or extend any spec under `spec/16-generic-release/` that
   describes the change (this file, `04-install-scripts.md`,
   `07-release-metadata.md`, etc.).
