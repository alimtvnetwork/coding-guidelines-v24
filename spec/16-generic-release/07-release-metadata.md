...
| App Spec | Covers |
|----------|--------|
| [14-release-assets.md](../14-update/14-release-assets.md) | Release asset manifest structure and published file list |
| [16-release-versioning.md](../14-update/16-release-versioning.md) | Per-release metadata, `latest.json`, and semver rules |
