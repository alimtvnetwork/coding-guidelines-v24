...
> [09-version-pinned-release-installers.md](09-version-pinned-release-installers.md)
...
| App Spec | Covers |
|----------|--------|
| [07-install-script-generation.md](../12-cicd-pipeline-workflows/07-install-script-generation.md) | Version-pinned install scripts in the release pipeline |
