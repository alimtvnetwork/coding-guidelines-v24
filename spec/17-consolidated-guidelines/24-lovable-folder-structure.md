...
**Version:** 3.3.0  
**Updated:** 2026-04-16  
**Source:** [`spec/01-spec-authoring-guide/09-memory-folder-guide.md`](../01-spec-authoring-guide/09-memory-folder-guide.md)
...
1. High-level items tracked in `29-plan.md` as a roadmap
...
Enforcement: see `21-database-conventions.md` §18 (rule presence) and §19 (waiver syntax).
...
| `.lovable/` structure | Single-file convention — `29-plan.md`, `suggestions.md`, `strictly-avoid.md` each hold their full history. **Never** create per-task folders |
