...
**Version:** 3.3.0  
**Updated:** 2026-04-16  
**Source Module:** [`spec/18-wp-plugin-how-to/`](../18-wp-plugin-how-to/01-index.md)
...
|-------|---------------|
| Quick Start | `spec/18-wp-plugin-how-to/02-quick-start.md` |
| Foundation & Architecture | `spec/18-wp-plugin-how-to/03-foundation-and-architecture.md` |
| Enums & Coding Style | `spec/18-wp-plugin-how-to/02-enums-and-coding-style/` |
| Traits & Composition | `spec/18-wp-plugin-how-to/04-traits-and-composition.md` |
| Logging & Error Handling | `spec/18-wp-plugin-how-to/05-logging-and-error-handling.md` |
| Input Validation | `spec/18-wp-plugin-how-to/07-input-validation-patterns.md` |
| WordPress Integration | `spec/18-wp-plugin-how-to/09-wordpress-integration-patterns.md` |
| Deployment Patterns | `spec/18-wp-plugin-how-to/11-deployment-patterns.md` |
| REST API Conventions | `spec/18-wp-plugin-how-to/15-rest-api-conventions.md` |
| Settings Architecture | `spec/18-wp-plugin-how-to/16-settings-architecture.md` |
| Micro ORM & Root DB | `spec/18-wp-plugin-how-to/20-micro-orm-and-root-db.md` |
| Ping Endpoint | `spec/18-wp-plugin-how-to/22-ping-endpoint.md` |
| End-to-End Walkthrough | `spec/18-wp-plugin-how-to/21-end-to-end-walkthrough.md` |
