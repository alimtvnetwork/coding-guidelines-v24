...
| # | Suggestion | Priority |
|---|---|---|
| 17 | Add a `## For AI Agents` section right after the H1 summary listing the canonical entry points: `llm.md`, `bundles.json`, `spec/17-consolidated-guidelines/01-index.md`, `.lovable/memory/01-index.md`. | 🔴 |
