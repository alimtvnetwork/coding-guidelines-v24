...
order to (a) ship a GitHub Release of `coding-guidelines-v20` and (b)
...
```bash
# Linux / macOS
curl -fsSL https://github.com/<org>/coding-guidelines-v20/releases/latest/download/install.sh | bash
```

```powershell
# Windows
irm https://github.com/<org>/coding-guidelines-v20/releases/latest/download/install.ps1 | iex
```
...
2. **Download** the spec + linters tree via
   `codeload.github.com/<org>/coding-guidelines-v20/zip/refs/heads/main`.
...
```bash
curl -fsSLO https://github.com/<org>/coding-guidelines-v20/releases/latest/download/install.sh
curl -fsSLO https://github.com/<org>/coding-guidelines-v20/releases/latest/download/checksums.txt
