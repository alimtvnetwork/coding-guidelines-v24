...
| CI/CD pipeline specs | `spec/17-consolidated-guidelines/18-cicd-pipeline-workflows.md` |
| Split DB architecture | `spec/17-consolidated-guidelines/08-split-db-architecture.md` |
| Spec authoring | `spec/17-consolidated-guidelines/04-spec-authoring.md` |
