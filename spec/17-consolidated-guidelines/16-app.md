...
| Reference | Location |
|-----------|----------|
| App Issues | `spec/17-consolidated-guidelines/17-app-issues.md` |
| App Database | `spec/17-consolidated-guidelines/25-app-database.md` |
| App Design System | `spec/17-consolidated-guidelines/19-app-design-system-and-ui.md` |
| Coding Guidelines | `spec/17-consolidated-guidelines/34-compiled-simple-coding-guidelines.md` |
| Spec Authoring Guide | `spec/17-consolidated-guidelines/04-spec-authoring.md` |
