...
- [02-ci-pipeline.md](./02-ci-pipeline.md) — CI pipeline architecture
- [05-release-pipeline.md](./05-release-pipeline.md) — Release pipeline architecture
- [16-binary-icon-branding.md](./16-binary-icon-branding.md) — Windows icon embedding
- [spec/07-generic-release/08-known-issues-and-fixes.md](../07-generic-release/08-known-issues-and-fixes.md) — Release-specific issue catalog
