...
| # | File | Description | Status |
|---|------|-------------|--------|
| 00 | [01-index.md](./01-browser-extension-deploy/01-index.md) | Overview of browser extension pipeline | ✅ Active |
...
| # | File | Description | Status |
|---|------|-------------|--------|
| 00 | [01-index.md](./02-go-binary-deploy/01-index.md) | Overview of Go binary pipeline | ✅ Active |
...
| # | File | Description | Status |
|---|------|-------------|--------|
| 00 | [01-index.md](./03-reusable-ci-guards/01-index.md) | Pattern inventory + design principles for AI-portable CI guards | ✅ Active |
...
| PowerShell Automation | `../11-powershell-integration/01-index.md` |
