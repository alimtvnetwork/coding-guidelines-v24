...
binary), see [10-version-verification.md](10-version-verification.md).
...
| [11-self-update-mechanism.md](../12-cicd-pipeline-workflows/11-self-update-mechanism.md) | Handoff, version verification, release artifacts, and rollback |
| [20-self-update-app-update.md](../17-consolidated-guidelines/20-self-update-app-update.md) | Consolidated update workflow, release pipeline, and install-script behavior |
