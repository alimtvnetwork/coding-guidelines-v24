...
- [05-build-scripts.md](05-build-scripts.md) §Build Step — must invoke `go-winres make` on Windows
- [13-code-signing.md](13-code-signing.md) — sign AFTER `.syso` is linked, never before
