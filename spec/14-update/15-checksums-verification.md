...
- [Release Assets](./14-release-assets.md) — What files are checksummed
- [Release Versioning](./16-release-versioning.md) — Version resolution for download URLs
- [CI/CD Shared Conventions](../12-cicd-pipeline-workflows/03-shared-conventions.md) — Checksum conventions in CI
