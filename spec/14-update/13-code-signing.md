...
- The `update` command MUST verify the signature on a downloaded
  ...
  [`../14-update/15-checksums-verification.md`](../14-update/15-checksums-verification.md).
...
- [05-build-scripts.md](05-build-scripts.md) §Build Step — sign as last step before deploy
- [12-windows-icon-embedding.md](12-windows-icon-embedding.md) — sign AFTER `.syso` is linked, never before
- [`../14-update/15-checksums-verification.md`](../14-update/15-checksums-verification.md) — checksum + signature flow for binary-based update
- [`../14-update/18-release-pipeline.md`](../14-update/18-release-pipeline.md) — CI pipeline that orchestrates signing
