...
| App Spec | Covers |
|----------|--------|
| [11-self-update-mechanism.md](../12-cicd-pipeline-workflows/11-self-update-mechanism.md) | Self-update orchestration, worker lifecycle, and rollback expectations |
| [20-self-update-app-update.md](../17-consolidated-guidelines/20-self-update-app-update.md) | Consolidated handoff, foreground blocking, and app-update behavior |
