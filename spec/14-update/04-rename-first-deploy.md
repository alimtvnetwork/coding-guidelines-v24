...
- The `.old` file is left in place — it is cleaned up by a separate
  `update-cleanup` command (see [07-cleanup.md](07-cleanup.md)).
...
| [11-self-update-mechanism.md](../12-cicd-pipeline-workflows/11-self-update-mechanism.md) | Rename-first during self-update, rollback on failure |
| [20-self-update-app-update.md](../17-consolidated-guidelines/20-self-update-app-update.md) | Consolidated rename-first deploy contract |
