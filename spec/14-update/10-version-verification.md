# 10 — Version Verification (Three-Branch)
...
- [02-self-update-overview.md](02-self-update-overview.md) §Version Comparison
- [04-rename-first-deploy.md](04-rename-first-deploy.md) §PATH Sync
- [06-handoff-mechanism.md](06-handoff-mechanism.md) §Two-Phase Summary
- [07-cleanup.md](07-cleanup.md) §Automatic Cleanup (must run after verify)
