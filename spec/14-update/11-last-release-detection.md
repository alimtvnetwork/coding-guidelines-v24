...
- [05-build-scripts.md](05-build-scripts.md) §Version Verification — uses this script
- [02-self-update-overview.md](02-self-update-overview.md) §Skip-if-Current — calls this for the comparison
- [`../14-update/24-install-script-version-probe.md`](../14-update/24-install-script-version-probe.md) — install probe uses similar tiered fallback
