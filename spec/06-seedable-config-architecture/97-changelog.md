...
Updated all references from `coding-guidelines-v20` to `coding-guidelines-v20` across distribution and CI/CD specifications.

#### Changed
- Install scripts, CI templates, and release pipelines now reference `coding-guidelines-v20` repository slug
