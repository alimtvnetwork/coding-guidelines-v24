...
Updated all references from `coding-guidelines-v16` to `coding-guidelines-v16` across distribution and CI/CD specifications.

#### Changed
- Install scripts, CI templates, and release pipelines now reference `coding-guidelines-v16` repository slug
