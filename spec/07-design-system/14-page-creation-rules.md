...
This prevents visual noise. Stick to the shared transitions from [08-motion-transitions.md](./08-motion-transitions.md).
...
Build pages by composing section patterns from [13-section-patterns.md](./13-section-patterns.md):
...
All interactive elements on new pages must follow the state language from [02-design-principles.md](./02-design-principles.md):
...
| Reference | Location |
|-----------|----------|
| Section Patterns | [13-section-patterns.md](./13-section-patterns.md) |
