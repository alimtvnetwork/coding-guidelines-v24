...
| Reference | Location |
|-----------|----------|
| Theme Variable Architecture | [03-theme-variable-architecture.md](./03-theme-variable-architecture.md) |
| Design Principles (Portability) | [02-design-principles.md](./02-design-principles.md) |
