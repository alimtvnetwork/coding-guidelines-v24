...
| 02 | [02-enums-and-coding-style/](02-enums-and-coding-style/01-index.md) | Enums & Coding Style | Backed enum architecture (4 categories), `match`-based metadata pattern, `PluginConfigType`, `PhpNativeType`, coding style rules (conditionals, formatting, naming, PHPDoc) |
