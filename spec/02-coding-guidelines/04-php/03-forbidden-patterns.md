...
> **Version:** 4.0.0  
> **Updated:** 2026-03-09  
> **Consolidates:** [readme.md](./07-php-standards-reference/01-index.md), [enums.md](./02-enums.md), WP Error Handling <!-- external: spec/28-wp-plugin-development/07-error-handling.md -->
