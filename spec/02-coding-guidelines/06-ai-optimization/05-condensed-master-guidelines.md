...
**Purpose:** Sub-200-line distillation of [15-master-coding-guidelines.md](../01-cross-language/15-master-coding-guidelines/01-index.md) for AI context windows. See also: [05-enum-naming-quick-reference.md](./05-enum-naming-quick-reference.md) for detailed enum rules.
