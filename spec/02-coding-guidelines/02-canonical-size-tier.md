...
> All other locations (`.cursorrules`, `eslint.config.js`, `linters-cicd/`, `spec/13-generic-cli/08-code-style.md`, `spec/17-consolidated-guidelines/34-compiled-simple-coding-guidelines.md`) mirror this table and MUST reference it. If any of those drift, this file wins and the others get patched.
...
| `spec/17-consolidated-guidelines/34-compiled-simple-coding-guidelines.md` §"File Size Limits" | Consolidated guidelines mirror |
