...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v20/main/linters-install.ps1))) -Version v5.8.0 -Target .\vendor
#>
...
Write-Host "  📦 linters-install v5.8.0" -ForegroundColor Cyan
