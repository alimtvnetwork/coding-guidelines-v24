...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v16/main/linters-install.ps1))) -Version v3.77.0 -Target .\vendor
#>
...
Write-Host "  📦 linters-install v3.77.0" -ForegroundColor Cyan
