...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/linters-install.ps1))) -Version v6.18.1 -Target .\vendor
#>
...
$BundleName = "linters"
$BundleMapping = "linters|linters,linters-cicd|linters-cicd,version.json|version.json,.lovable/what-to-read.md|.lovable/what-to-read.md"
...
Write-Host "  📦 linters-install v6.18.1" -ForegroundColor Cyan
