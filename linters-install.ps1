...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v15/main/linters-install.ps1))) -Version v4.7.0 -Target .\vendor
#>
...
Write-Host "  📦 linters-install v4.7.0" -ForegroundColor Cyan
