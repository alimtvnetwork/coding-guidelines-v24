...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v20/main/linters-install.ps1))) -Version v5.7.0 -Target .\vendor
#>
...
Write-Host "  📦 linters-install v5.7.0" -ForegroundColor Cyan
