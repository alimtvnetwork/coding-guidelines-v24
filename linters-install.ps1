...
.EXAMPLE
    & ([scriptblock]::Create((irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v24/main/linters-install.ps1))) -Version v6.35.3 -Target .\vendor
#>
...
$BundleName = "linters"
$BundleMapping = "linters|linters,linters-cicd|linters-cicd,version.json|version.json,.lovable/what-to-read.md|.lovable/what-to-read.md,.lovable/memory|.lovable/memory"
...
Write-Host "  📦 linters-install v6.35.3" -ForegroundColor Cyan
