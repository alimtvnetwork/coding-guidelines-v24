...
> **Version:** <!-- STAMP:VERSION -->5.131.0<!-- /STAMP:VERSION -->
> **Updated:** <!-- STAMP:UPDATED -->2026-07-19<!-- /STAMP:UPDATED -->
> **Stats:** <!-- STAMP:FILES -->682<!-- /STAMP:FILES --> spec files across <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders (<!-- STAMP:LINES -->145,813<!-- /STAMP:LINES --> lines).
