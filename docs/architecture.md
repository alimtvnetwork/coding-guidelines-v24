...
> **Version:** <!-- STAMP:VERSION -->6.18.0<!-- /STAMP:VERSION -->
> **Updated:** <!-- STAMP:UPDATED -->2026-08-25<!-- /STAMP:UPDATED -->
> **Stats:** <!-- STAMP:FILES -->707<!-- /STAMP:FILES --> spec files across <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders (<!-- STAMP:LINES -->146,937<!-- /STAMP:LINES --> lines).
