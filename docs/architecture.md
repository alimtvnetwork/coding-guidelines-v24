...
> **Version:** <!-- STAMP:VERSION -->5.24.0<!-- /STAMP:VERSION -->
> **Updated:** <!-- STAMP:UPDATED -->2026-05-07<!-- /STAMP:UPDATED -->
> **Stats:** <!-- STAMP:FILES -->669<!-- /STAMP:FILES --> spec files across <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders (<!-- STAMP:LINES -->143,945<!-- /STAMP:LINES --> lines).
