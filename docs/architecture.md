...
> **Version:** <!-- STAMP:VERSION -->6.9.0<!-- /STAMP:VERSION -->
> **Updated:** <!-- STAMP:UPDATED -->2026-08-22<!-- /STAMP:UPDATED -->
> **Stats:** <!-- STAMP:FILES -->705<!-- /STAMP:FILES --> spec files across <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders (<!-- STAMP:LINES -->145,378<!-- /STAMP:LINES --> lines).
