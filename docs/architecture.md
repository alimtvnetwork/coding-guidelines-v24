...
> **Updated:** <!-- STAMP:UPDATED -->2026-08-30<!-- /STAMP:UPDATED -->
> **Stats:** <!-- STAMP:FILES -->692<!-- /STAMP:FILES --> spec files across <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders (<!-- STAMP:LINES -->148,779<!-- /STAMP:LINES --> lines).
