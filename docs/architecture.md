...
> **Version:** <!-- STAMP:VERSION -->6.21.0<!-- /STAMP:VERSION -->
> **Updated:** <!-- STAMP:UPDATED -->2026-08-27<!-- /STAMP:UPDATED -->
> **Stats:** <!-- STAMP:FILES -->707<!-- /STAMP:FILES --> spec files across <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders (<!-- STAMP:LINES -->149,481<!-- /STAMP:LINES --> lines).
