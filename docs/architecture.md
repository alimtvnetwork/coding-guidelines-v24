...
> **Version:** <!-- STAMP:VERSION -->6.18.1<!-- /STAMP:VERSION -->
> **Updated:** <!-- STAMP:UPDATED -->2026-08-26<!-- /STAMP:UPDATED -->
> **Stats:** <!-- STAMP:FILES -->707<!-- /STAMP:FILES --> spec files across <!-- STAMP:FOLDERS -->23<!-- /STAMP:FOLDERS --> top-level folders (<!-- STAMP:LINES -->148,475<!-- /STAMP:LINES --> lines).
