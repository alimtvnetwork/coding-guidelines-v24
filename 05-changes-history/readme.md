...
```
05-changes-history/
├── readme.md                                    # This master index and convention specification
...
| 18 | [`18-streamer-and-writer-self-passing-research`](18-streamer-and-writer-self-passing-research/01-transaction-log.md) | Streamer & Writer refinements, self-passing injected methods (self), lock/unlock controls, AppError standard, and cross-language naming | Completed | 2026-09-04 |
| 19 | [`19-leaf-enums-baseenumer-helpers-and-cycle-elimination`](19-leaf-enums-baseenumer-helpers-and-cycle-elimination/01-transaction-log.md) | Leaf enum architecture, baseenumer Parse/ParseOrZero methods, eliminating result wrap to resolve Go import cycles | Completed | 2026-09-09 |
| 20 | [`20-comprehensive-tests-for-enums-and-baseenumer`](20-comprehensive-tests-for-enums-and-baseenumer/01-transaction-log.md) | Comprehensive tests for all enums, baseenumer helpers, edge cases, and 100% coverage audit | Completed | 2026-09-09 |
| 21 | [`21-completed-plans-consolidation`](21-completed-plans-consolidation/01-transaction-log.md) | Completed plans consolidation, safety backup branch creation, clustering into 6 milestones, and sequence integrity verification | Completed | 2026-09-09 |
| 22 | [`22-split-sqlite-logging-rotating-lazyonce-errcmd`](22-split-sqlite-logging-rotating-lazyonce-errcmd/01-transaction-log.md) | Split SQLite DB logging, configurable text file rotation, generic LazyOnce, and errcmd integration | Completed | 2026-09-09 |
| 23 | [`23-sqlite-task-db-auto-migration-and-repair`](23-sqlite-task-db-auto-migration-and-repair/01-transaction-log.md) | Automatic schema audit, column repair, index creation, and migration engine for SQLite task databases | Completed | 2026-09-09 |
| 24 | [`24-task-retention-errcmd-streaming-atomic-fileutil-lazyonce-apimanager`](24-task-retention-errcmd-streaming-atomic-fileutil-lazyonce-apimanager/01-transaction-log.md) | Task database retention pruning, live errcmd streaming, atomic file writing, lazyonce context, and ApiManager | Completed | 2026-09-09 |
| 25 | [`25-regex-harvesting-dbengine-and-isdefined-standard`](25-regex-harvesting-dbengine-and-isdefined-standard/01-transaction-log.md) | Regex harvesting from 03-aukgo/core, lazy regex centralization, generic dbengine wrapper, Python struct scaffolder, and isDefined positive check standard | Completed | 2026-09-13 |
| 26 | [`26-write-prompts-git-audit-and-recent-tasks-register`](26-write-prompts-git-audit-and-recent-tasks-register/01-transaction-log.md) | Write prompts upgrade (v2.2.0), mandatory 30-commit git history audit, recent 20-task tracking register, and 19-box verification checklist | Completed | 2026-09-13 |
