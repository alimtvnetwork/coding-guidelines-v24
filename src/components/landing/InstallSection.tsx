...
const installCommands: InstallCommand[] = [
  {
    platform: "Windows",
    shell: "PowerShell",
    command: "irm https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v20/main/install.ps1 | iex",
  },
  {
    platform: "macOS / Linux",
    shell: "Bash",
    command: "curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/coding-guidelines-v20/main/install.sh | bash",
  },
];
        ...
        <div className="mt-16">
          <div className="mb-6 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Install just the spec folders you need — each bundle points at coding-guidelines-v20.
            </p>
          </div>
          <div className="grid gap-4 md:grid-cols-2">
